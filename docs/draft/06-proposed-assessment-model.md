...
\begin{table*}[t]
  ...
  \begin{tabular}{@{} L{2.2cm} L{5.8cm} L{3.5cm} L{3.5cm} @{} }
    ...
    **TECH-3** Adaptivity & IRT-based difficulty calibration and prompt stability & Adaptive Learning~[b15]; GenAI~[b37][b40] & Item difficulty alignment and prompt stability audit 
    ...
    **TECH-5** Mobile & Responsive design and offline-first capabilities & MALL~[b5] & Accessibility and offline function check 
    \midrule
    **PED-1** Alignment & Materials aligned to IELTS/TOEFL standard rubrics & Authenticity~[b1]; Washback~[b21] & Item format and CEFR level matching 
    ...
    **INST-2** Interoperability & Integration with LMS/SIAKAD via LTI/API standards & IMS Standards~[b26] & Technical connection protocol audit 
